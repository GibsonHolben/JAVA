 ...
 * @version 0.2.6
 *  <p> A private version of the simple class used to fill
 *   in the specs for a computer.</p>
...
public class ComputerPrivate
{
	 ...
	 * wants (Intel or AMD)
	 */
	ComputerPrivate(String PreBuilt)
	{
	 ...
	 */
	ComputerPrivate(String procsser, String Graphics, String SolidState,
			String HardDisk,String Memory, String Motherboard, String Case,
	...
	/**Returns the size of the HDD
	 * @return hddValue
	 */
	public short getHddValue() {
		return hddValue;
	}
	...
	/**
	 * Sets a Computers variables by asking the user in
